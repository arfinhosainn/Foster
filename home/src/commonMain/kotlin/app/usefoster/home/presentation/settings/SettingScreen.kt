...
import app.usefoster.home.presentation.settings.components.AppearanceBottomSheet
import app.usefoster.home.presentation.settings.components.DeleteAccountBottomSheet
import app.usefoster.home.presentation.settings.components.PremiumCard
import app.usefoster.home.presentation.settings.components.SettingsGroup
import app.usefoster.home.presentation.settings.components.SettingsRow
...
import foster.home.generated.resources.ic_terms
                ...
                modifier = Modifier
                    ...
                    .background(
                        Brush.verticalGradient(
                            colorStops = arrayOf(
                                0.0f to FosterTheme.colors.background.b0,
                                0.4f to FosterTheme.colors.background.b0.copy(alpha = 0.85f),
                                0.75f to FosterTheme.colors.background.b0.copy(alpha = 0.3f),
                                1.0f to FosterTheme.colors.background.b0.copy(alpha = 0f),
                            ),
                        ),
                    ),
            )
...
@Composable
fun PreviewSettingScreen() = FosterTheme {
