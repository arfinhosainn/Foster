package app.usefoster.home.presentation.dayagenda
...
import app.usefoster.home.domain.DueItem
...
private fun DayAgendaRow(
    ...
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .background(FosterTheme.colors.fill.quaternary, RoundedCornerShape(20.dp))
            .clickable(
