...
fun OnboardingProfileError.toUserMessage(): String = when (this) {
    ...
    OnboardingProfileError.ProfileNotFound -> "We could not find your profile. Try again"
    ...
    is OnboardingProfileError.Unknown -> "Something went wrong. Please try again"
}
